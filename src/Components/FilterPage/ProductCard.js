...
const ProductCard = () => {
  return (
    <div>
      <div className="card overflow-visible lg:card-side bg-gray-100/80 p-2 border shadow-xl">
        <figure>
        ...
        <div className="px-3 w-full">
          <div className="flex justify-between items-items">
            <div className="div">
              <h2 className="text-2xl">CasaGrand Hazen</h2>
          ...
          <div className="card-actions justify-between mt-8">
            <p className="text-2xl font-bold">₹ 25 L - 2 Cr</p>
